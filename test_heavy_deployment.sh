...
set_config_key "taskmanager.heap.size" "1024m" # 512Mb x 10TMs = 5Gb total heap
...
set_config_key "mesos.resourcemanager.tasks.cpus" "1"
...
$FLINK_DIR/bin/flink run -m localhost:${REST_PORT} ${TEST_PROGRAM_JAR} \
