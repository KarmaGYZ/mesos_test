...
set_config_key "mesos.resourcemanager.tasks.mem" "4096"
...
$FLINK_DIR/bin/flink run -m localhost:${REST_PORT} -c org.apache.flink.table.tpcds.TpcdsTestProgram "$TARGET_DIR/TpcdsTestProgram.jar" -sourceTablePath "$TPCDS_DATA_DIR" -queryPath "$TPCDS_QUERY_DIR" -sinkTablePath "$RESULT_DIR" -useTableStats "$USE_TABLE_STATS"
