...
set_config_key "taskmanager.network.memory.min" "111149056"
set_config_key "taskmanager.network.memory.max" "111149056"

# set_conf_ssl "server"
start_cluster


$FLINK_DIR/bin/flink run -m localhost:${REST_PORT} -p 4 $TEST_PROGRAM_JAR --loadFactor 4 --outputPath $TEST_DATA_DIR/out/dataset_allround
